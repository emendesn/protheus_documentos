...
|Motivo: Inclusão campo Turno de Trabalho e Manutenção Filtro por Data de Admissão                                                                                                     |
|Resposável: Anadi                                                                                                                                                                     |
|Validado por: Luciana Benicio de Souza                                                                                                                                                |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|Motivo: Alterar campo "LOCAL DE ENTREGA" para 150 (matriz) e 1121 (filial)                                                                                                            |
|Resposável: Anadi                                                                                                                                                                     |
|Validado por: Luciana Benicio de Souza                                                                                                                                                |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|Validado por: Luciana Benicio de Souza                                                                                                                                                |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|Data Alteração: 08/07/2013                                                                                                                                                            |
|Motivo: Desconto em Folha                                                                                                                                                             |
|Resposável: Anadi                                                                                                                                                                     |
|Validado por: Luciana Benicio de Souza                                                                                                                                                |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
//			SRX->(DbSeek("  26" + QRY1->RA_FILIAL + "          " + QRY1->RA_VALEREF))  alterado pelo Daniel Cardoso em 20/08/14
			SRX->(DbSeek("  " + "26" + QRY1->RA_FILIAL + "                   ")) // + QRY1->RA_VALEREF))
...
cPerg := PADR(cPerg,6)
  ...
  AAdd(aRegs,{cPerg,"04","Tipode Vale?      ","","","mv_ch4","C",05,0,0,"G","u_xFvale","mv_par04","","","","","","","","","","","","","","","","","","","","","","","","","",""})
  ...
  AAdd(aRegs,{cPerg,"09","Admissão de?      ","","","mv_ch9","D",08,0,0,"G","","mv_par09","","","","","","","","","","","","","","","","","","","","","","","","","",""})
  AAdd(aRegs,{cPerg,"10","Admissão ate?     ","","","mv_cha","D",08,0,0,"G","","mv_par10","","","","","","","","","","","","","","","","","","","","","","","","","",""})
