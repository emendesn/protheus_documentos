...
±±ºPrograma  ³LP672DB   ºAutor  ³ Edson Rodrigues    º Data ³17/12/2009   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Programa para retorno da conta a credito para todas as se-  º±±
±±º          ³quencias do lancamento padronizado 672 - Transferências /  -º±±
±±º          ³Transferências Mod 2- Entrada de saldo em estoque(Devolucao)º±± 
±±º          - movimento destino.                                        -º±±
±±º                                                                      -º±±
