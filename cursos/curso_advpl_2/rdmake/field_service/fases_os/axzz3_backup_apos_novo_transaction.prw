...
±±∫Programa  ≥ AXZZ3    ∫Autor  ≥Edson B. - Erp Plus ∫ Data ≥  24/04/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Rotina para apontamento das fases de Ordens de Servico.    ∫±±
±±∫          ≥                                                            ∫±±
...
aAdd( aRotina, {"Apontar &PeÁa"	,"U_APONTPCA"                       ,0,5})
...
If Empty(Posicione("SX3",1,cString,"X3_ARQUIVO"))
	Help("",1,"","NOX3X2IX","N√O … POSSÕVEL EXECUTAR, FALTA"+ENTER+"X3, X2, IX E X7",1,0)
	RETURN
Endif
...
If lUsrNext .Or. lUsrAdmi
	...
	If Empty(AllTrim(_lAltTec))
		...
		MsgStop("Usu·rio Sem Cadastro, Favor Entrar em Contato com Supervisor","Erro Cadastro")
...
±±∫Programa  ≥AXZZ3ALTVIS∫Autor  ≥Edson B. - ERP Plus ∫ Data ≥  28/04/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥Rotina de inclusao, alteracao, exclusao e visualizacao       ∫±±
±±∫          ≥da tabela ZZ3.                                               ∫±±
...
//Monta aHeader para o MSGetDados() usando os campos a tabela tempor·ria TRB
...
@ aPosObj[1,1]+_nLin1 ,	aPosObj[1,1]+_nCol1 	SAY "TÈcnico" 		    SIZE 70,7 PIXEL OF oDlg
@ aPosObj[1,1]+_nLin1 ,	aPosObj[1,1]+_nCol2		SAY "LaboratÛrio"  		SIZE 70,7 PIXEL OF oDlg
...
Endif
//O MSGET trunca os nomes da vari·veis, deixando-as com o tamanho 10
...
ACTIVATE MSDIALOG oDlg ON INIT EnchoiceBar(oDlg,{||U_STATUSOK(1),IIf(_lscreen,.F.,oDlg:End())},{||U_GRAVA(), oDlg:End()},,{{'DBG06',{|| U_AddPartNO(2,.T.)},'Part. No.'},{'EDITABLE',{|| U_ADDPECAF(2)},'Pcs. Falt.'}}) //alteracao - Edson Rodrigues 28/09/08
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ADDPARTNO ∫Autor  ≥Edson B. - ERP Plus ∫ Data ≥  30/05/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥Funcao para chamar rotina de inclusao de PartNo             ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
	...
	ElseIf _nOpc == 2 //Quando aperta o Botao da enchoice
		...
		If ReadVar(N) = "" //Se estiver posicionado no aCols
			...
			If !_cinfprtn='0'
				...
				EndIf
			Else
				Aviso("Part.no Proibido","… Proibida a Inclusao de Part.no para a Fase apontada nesse IMEI/OS : "+AllTrim(aCols[N,_nPosIMEI])+"/"+AllTrim(aCols[N,_nPosOS])+".",{"OK"})
			EndIf
			
		Else
			apMsgInfo("Caro usu·rio, posicione no IMEI desejado para habilitar a rotina de apontamento de Part Numbers","Posicionar no IMEI desejado")
		EndIf
	EndIf
Else
	Aviso("Part.no Proibido","… Proibida a Inclusao de Part.no para a Fase Atual",{"OK"})
EndIf
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ADDPECAF  ∫Autor  ≥Edson Rodrigues-BGH ∫ Data ≥  25/09/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥Funcao para chamar rotina de inclusao de Pecas Faltantes    ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
	...
	ElseIf _nOpc == 2 //Quando aperta o Botao da enchoice
		If ReadVar(N) = "" //Se estiver posicionado no aCols
			...
			If _cpecfal='S'
				...
				EndIf
			Else
				Aviso("Cadastro de Peca Faltante Proibido","… Proibida a Inclusao de Peca faltante a Fase apontada nesse IMEI/OS : "+AllTrim(aCols[N,_nPosIMEI])+"/"+AllTrim(aCols[N,_nPosOS])+".",{"OK"})
			EndIf
		Else
			apMsgInfo("Caro usu·rio, posicione no IMEI desejado para habilitar a rotina de Pecas Faltantes","Posicionar no IMEI desejado")
		EndIf
	EndIf
Else
	Aviso("Part.no Proibido","… Proibida a Inclusao de PeÁas.Faltantes na Fase Atual",{"OK"})
EndIf
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥AltCabec  ∫Autor  ≥Edson B. - ERP Plus ∫ Data ≥  05/05/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥Atualiza campos do cabecalho                                ∫±±
±±∫          ≥                                                            ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
...
Do Case
	...
	Case _cTab == "AA1"
		...
		If (lUsrNext .Or. lUsrAdmi) .And. !Empty(CODANA)
			...
			if Posicione("AA1",1,xFilial("AA1") + CODANA, "AA1_ALOCA") == "2"
				_lRet := .F.
				apMsgStop("TÈcnico indisponÌvel para atendimento de OS. Por favor, contate seu supervisor!", "TÈcnico indisponÌvel")
			endif
		...
		//Verifica se usu·rio tem algum algum apontamento nao confirmado
		...
		If ZZ3->(dbSeek(xFilial("ZZ3") + _cLab + CODTEC + '0'))
			If ApMsgYesNo("Existem apontamentos n„o confirmados para este cÛdigo de tÈcnico. Deseja visualizar estes apontamentos? Caso os apontamentos existentes n„o sejam tratados neste momento, os mesmos ser„o apagados.","Apontamentos existentes")
				Begin transaction
				While ZZ3->(!eof()) .And. ZZ3->ZZ3_FILIAL == xFilial("ZZ3") .And. ZZ3->ZZ3_LAB == _cLab .And. ;
					...
					If !ZZ3->ZZ3_STATRA='1' // Ve se o aparelho esta sendo usado por algum outro usuario nesse mesmo tecnico. Edson Rodrigues - 28/07/10
						...
						//Verificac se aCols esta vazio. Se n„o estiver adiciona uma linha
						...
						//grava status 1 para ninguÈm mais usar esse registro enquanto estiver em array/acols
						reclock("ZZ3",.F.)
						ZZ3->ZZ3_STATRA :='1'
					...
					Else
						If ALLTRIM(ZZ3->ZZ3_USER)=ALLTRIM(cUserName)
							MsgAlert("O IMEI/OS : "+ALLTRIM(ZZ3->ZZ3_IMEI)+"/"+ALLTRIM(ZZ3->ZZ3_NUMOS)+" esta em sendo apontado no tecnico :"+AllTrim(ZZ3->ZZ3_CODTEC)+" pelo seu usu·rio : "+AllTrim(ZZ3->ZZ3_USER)+".","Apontamento em Uso")
						...
						Else
							MsgAlert("O IMEI/OS : "+ALLTRIM(ZZ3->ZZ3_IMEI)+"/"+ALLTRIM(ZZ3->ZZ3_NUMOS)+" esta em sendo apontado no tecnico :"+AllTrim(ZZ3->ZZ3_CODTEC)+" pelo usu·rio : "+AllTrim(ZZ3->ZZ3_USER)+".","Apontamento em Uso")
			...
			Else
				...
				While ZZ3->(!eof()) .And. ZZ3->ZZ3_FILIAL == xFilial("ZZ3") .And. ;
					...
					//Permite so deletar e voltar o status da transacao dos aparelhos forem do mesmo usu·rio ou nao estiverem em uso- Edson Rodrigues
					If (ZZ3->ZZ3_STATRA ='0') .OR. (ZZ3->ZZ3_STATRA ='1' .And. ALLTRIM(ZZ3->ZZ3_USER)=ALLTRIM(cUserName))
						
						//Retirado linhas de cÛdigos e incluso funcao Edson Rodrigues - 28/07/10
						U_EXCLAPO2(_nreczz3)
						
						//Adicionado por Edson Rodrigues, pois o aparelho n„o retornava a fase atual no zz4 quando n„o se confirmava o apontamento -19/05/09
		...
		_lEncOs := iif(ZZ1->ZZ1_ENCOS == "S" .And. _lAltera .And. _lFase,.T.,.F.)
		...
		If ZZ1->ZZ1_PARTNR == "0"  //Verifica se para o IMEI informado È proibida a inclusao de part no.
			_lADDPARTNO := .F.
		Else
			_lADDPARTNO := .T.
		EndIf
	...
	Case _cTab == "Z81" //.And. Left(CODSET,6) == "000000"
		If !Empty(DEFDET).And. SX5->(dbSeek(xFilial("SX5") + "W7" + UPPER(ALLTRIM(DEFDET))))
			...
			If !Empty(DEFDET)
				_lRet := .T.
			Else
				apMsgStop("CÛdigo de Defeito Constatado n„o cadastrado.", "CÛdigo Invalido")
				_lRet := .F.
			Endif
		Else
			apMsgStop("Necessario CÛdigo de Defeito Constatado.", "CÛdigo Invalido")
			_lRet := .F.
		EndIf
	Case _cTab == "Z82" //.And. Left(CODSET,6) == "000000"
		If !Empty(DEFINF)
			...
			If  SZ8->(dbSeek(xFilial("SZ8") + LAB + LEFT(DEFINF,5)))
				...
				_lRet := .T.
			Else
				apMsgStop("CÛdigo de ReclamaÁ„o do Cliente n„o cadastrado.", "CÛdigo Invalido")
				DEFINF  := CriaVar("ZZ3_DEFINF"   ,.F.)
				_lRet := .F.
			EndIf
		Else
		...
		If !Empty(lSolu)
			...
			If !Empty(SOLUCAO) .And. !Empty(_lSolu)
				...
				If !Empty(_lSolu)
					_lRet := .T.
				Else
					apMsgStop("CÛdigo de SoluÁ„o n„o cadastrado.", "CÛdigo Invalido")
					_lRet := .F.
				EndIf
			Else
				apMsgStop("CÛdigo de SoluÁ„o n„o cadastrado.", "CÛdigo Invalido")
			...
			EndIf
		Else
			apMsgStop("CÛdigo de SoluÁ„o n„o confere.", "CÛdigo Invalido")
			_lRet := .F.
		EndIf
			...
			If  !Empty(CODSE2)
				...
				If (lUsrNext .Or. lUsrAdmi) .And. !Empty(CODANA)
					...
					if  !ZZB->(dbSeek(xFilial("ZZB") + CODANA + LAB + left(CODSE2,6)))
						apMsgStop("Setor Destino n„o cadastrado na amarraÁ„o Tecnico x Fase ","Setor Destino Invalido")
						_lRet := .F.
					Endif
		...
		If  !Empty(CODSET)
			...
			If (lUsrNext .Or. lUsrAdmi) .And. !Empty(CODANA)
				...
				if  !ZZB->(dbSeek(xFilial("ZZB") + CODANA + LAB + left(CODSET,6)))
					apMsgStop("Setor Atual n„o cadastrado na amarraÁ„o Tecnico x Fase ","Setor Atual Invalido")
					_lRet := .F.
				else
	...
	Case _cTab == "FAS1"
		...
		Else
			...
			apMsgStop("A fase Atual do Cadastro do Tecnico n„o esta cadastrada no cadastro de Tecnicos X Fase. Favor Cadastrar a fase atual no Cadastro de Tecnicos X Fases.","Fase Atual inv·lida")
		endif
	...
	Case _cTab == "FAS2"
		...
		if (LAB+AllTrim(CODSE2ORI)+AllTrim(FAS2Ori) == LAB+AllTrim(CODSETORI)+AllTrim(FAS1Ori)) .And. ENCOS <> "S"// alterado - Edson Rodrigues em 17/03/09
			apMsgStop("A fase destino n„o pode ser igual ‡ fase atual. Favor informar outra fase como destino.","Fase inv·lida")
			_lRet := .F.
		ElseIf !Empty(FAS2)
			...
			If !_lRet
				//Adicionada essa mensagem Edson Rodrigues em 09/03/09
				apMsgStop("A fase Destino n„o esta amarrada com a fase origem no cadastro de Fase Origem X Fase Destino. Favor Cadastrar a fase destino para essa fase origem no Cadastro de Fase Origem X Fase Destino.","Fase Destino inv·lida")
			Endif
			
		ElseIf Empty(FAS2) //Adcionado Edson Rodrigues - 17/03/09
			If _lEncOs .And. left(CODSETORI,6)<>left(CODSE2ORI,6)
				If !apMsgYesNo("A fase Origem "+FAS1+" pode encerrar a OS, porÈm o setor destino È diferente do setor Origem. Confirma o setor destino?","Setor destino diferente do setor Origem")
					_lRet := .F.
				Endif
			ElseIf  !_lEncOs
				apMsgStop("Favor informar uma fase destino, n„o È permitido apontar fase destino em branco quando a fse oriem n„o ecerra OS. Favor informar a fase destino.","Fase Destino inv·lida")
				_lRet := .F.
	...
	Case _cTab == "IMEINOVO"
		...
		If _lSwap2  .And. Empty(IMEINOVO)
			apMsgStop("A fase atual È SWAP favor informar o Imei do aparelho novo.","Codigo IMEI em Branco")
			_lRet := .F.
	...
	Case _cTab == "GONOGO"
		...
		Else
			...
			Else
				apMsgStop("A fase atual È GONOGO favor informar o codigo GoNoGo.","Codigo GonoGo")
				_lRet := .F.
			EndIf
		Endif
	Case _cTab =="MODIMEIN"
		...
		If _lSwap2  .And. Empty(MODIMEIN)
			apMsgStop("A fase atual È SWAP favor informar o modelo do aparelho novo.","Codigo Modelo em Branco")
			_lRet := .F.
		Endif
		...
		If !Empty(IMEI) .And. !Empty(CODTEC)
			...
			for _nw := 1 to len(aCols)
				if IMEI == aCols[_nw,_nPosIMEI] .And. !aCols[_nw,Len(aHeader)+1]
					apMsgStop("O IMEI j· foi apontado anteriormente nesta tela. Verifique o IMEI apontado.","IMEI j· apontado anteriormente")
					_lContinua := .F.
					exit
				endif
			next _nw
			...
			if Empty(FAS2) .And. ENCOS <> "S"
				apMsgStop("A fase de destino deve ser informada. O IMEI n„o foi gravado.","Fase destino n„o informada")
				_lContinua := .F.
			endif
			...
			If Empty(CODSE2)
				apMsgStop("Setor destino deve ser informado. O IMEI n„o foi gravado.","setor destino n„o informada")
				_lContinua := .F.
			...
			If _lDefInf .And. Empty(DEFINF)
				apMsgStop("Defeito Informado Obrigatorio. O IMEI n„o foi gravado.","Defeito Informado n„o informada")
				_lContinua := .F.
			...
			If _lDefDet .And. Empty(DEFDET)
				apMsgStop("Defeito Constatado Obrigatorio. O IMEI n„o foi gravado.","Defeito Constatado n„o informada")
				_lContinua := .F.
			...
			If _lSolucao .And. Empty(SOLUCAO)
				apMsgStop("Solucao Constatado deve ser informado. O IMEI n„o foi gravado.","Solucao Constatado n„o informada")
				_lContinua := .F.
			...
			If ZZ4->(dbSeek(xFilial("ZZ4") + IMEI))
				...
				If ZZ4->ZZ4_STATUS < "3" // Encontrou o IMEI mas o STATUS nao permite apontamento de fase
					_lContinua := .F.
					apMsgStop("Ainda n„o foi gerada NF de Entrada para este IMEI","IMEI sem NF de Entrada")
				ElseIf ZZ4->ZZ4_STATUS >= "5" // Encontrou o IMEI mas o STATUS nao permite apontamento de fase
					_lContinua := .F.
					apMsgStop("OS j· encerrada ou IMEI est· em processo de SaÌda Massiva","SaÌda Massiva")
				EndIf
			Else
				_lContinua := .F.
				apMsgStop("IMEI n„o Cadastrado","IMEI inv·lido")
			EndIf
			...
			if lCliente .And. !Empty(cCliente) .And. ENCOS = "S"  .And. (ZZ4->ZZ4_CODCLI <> cCliente .OR. ZZ4->ZZ4_LOJA <> cLoja)
				apMsgStop("Cliente do IMEI: " + ALLTRIM(ZZ4->ZZ4_CODCLI)+ "/ " +ZZ4->ZZ4_LOJA + " diferente do digitado na OS: " + ALLTRIM(cCliente)+ "/" +cLoja  ," Cliente Invalido")
				_lContinua := .F.
			endif
			/*--------------------------------------------------*/
			...
			if (!Empty(ZZ4->ZZ4_FASATU) .And. !Empty(ZZ4->ZZ4_SETATU)) .And. ((AllTrim(left(_cVerFaseta,6))+AllTrim(right(_cVerFaseta,6))) <> (AllTrim(FAS1Ori)+AllTrim(CODSETOri))) //.And. ENCOS<>"S" Desabilidado Edson Rodrigues em 16/04/09.
				apMsgStop("O IMEI encontra-se na fase/setor: "+ AllTrim(left(_cVerFaseta,6))+"/"+AllTrim(right(_cVerFaseta,6))+" e n„o poder· ser apontado da fase/setor: " + AllTrim(FAS1Ori)+"/"+AllTrim(CODSETOri)+"!","Fase Inv·lida")
				_lContinua := .F.
			endif
			...
			// Verifica se o IMEI est· sendo apontado da fase atual por outro tecnico e nao confirmada //  Edson Rodrigues - 24/05/10
			...
			// Verifica se o IMEI est· sendo apontado da fase atual por outro tecnico e nao confirmada //  Edson Rodrigues - 26/07/10
			...
			// Verifica se IMEI Possui documento de separacao
			If _lContinua .AND. GETMV("BH_VALMAP",.F.,.T.) .AND. ! EMPTY(ZZ4->ZZ4_ETQMEM) .AND. ZZ4->ZZ4_STATUS=='3'  // Parametro Para Validar Existencia da Etiqueta Master com o Documento planejado para ProduÁ„o)
			   ...
			   If ! DbSeek(xFilial("ZZY")+ZZ4->ZZ4_ETQMEM ,.F.)
				  apMsgStop("Etiqueta Master ["+ZZ4->ZZ4_ETQMEM+"] Nao Possui Documento de Separacao","Documento de Separacao")
                  _lContinua := .F.
     		   ElseIF ZZY->ZZY_TPRESE == "T"
				  apMsgStop("Etiqueta Master ["+ZZ4->ZZ4_ETQMEM+"] Nao Pode Separar Parcial","Separacao Parcial")
                  _lContinua := .F.
               Endif
            Endif
			If !_lContinua
			...
			if !left(CODSET,6) $ AllTrim(_csetmast) .And. ZZ4->ZZ4_NUMVEZ > 1 .And. !apMsgYesNo("Esta È a "+cvaltochar(ZZ4->ZZ4_NUMVEZ)+"a. vez que este aparelho est· sendo atendido. Confirma apontamento de fase?","Aparelho retornado")
				_lContinua := .F.
			ElseIf ZZ4->ZZ4_NUMVEZ > 1
				//verifica se o aparelho È bounce ou seja esta retornando menos que 90 dias. Edson Rodrigues - 20/07/09
				// Verifica data da ultima saida do IMEI
				_dUltSai := u_UltSai(ZZ4->ZZ4_IMEI,ZZ4->ZZ4_EMDT)
				_nBounce := 0
				If !Empty(_dUltSai)
					If !left(CODSET,6) $ AllTrim(_csetmast) .And. ZZ4->ZZ4_EMDT-_dUltSai < 90 .And. !apMsgYesNo("Este Aparelho esta retornando a  menos de 90 dias,  È Bounce. Confirma apontamento ?","Bounce do Aparelho")
						_lContinua := .F.
					Endif
				endif
			Endif
			...
			if !Empty(ZZ4->ZZ4_SWANT) .And. !ApMsgYesNo("Esse IMEI trata-se de SWAP ANTECIPADO e portanto n„o deveria sofrer atendimento. Confirma inclus„o do atendimento deste IMEI?","SWAP ANTECIPADO")
				_lContinua := .F.
			endif
			...
			If ZZ4->ZZ4_ASCRAP="S" .And. !ApMsgYesNo("Esse APARELHO foi baixado como SCRAP na ˙ltima vez que esteve na BGH e ele retornou. COMUNIQUE SEU SUPERIOR URGENTE !!. Quer continuar apontando esse IMEI ou n„o ?","APARELHO SCRAP")
				_lContinua := .F.
			EndIf
...
//					cimpmaste	:=ZZJ->ZZJ_SETMAS // variavel que obtem setor de impressao de etiqueta Master BGH
					...
					ccondic     :=SPACE(1)
				Else
					ApMsgInfo("N„o foi encontrado a operacao cadastrada para OS "+ZZ4->ZZ4_OS+" e IMEI "+ZZ4->ZZ4_IMEI+" no arquivo de Operacoes (ZZJ). Favor cadastrar.","Operacao n„o localizada!")
					_lContinua := .F.
					return(_lRet)
				EndIf
...
/*						If ctransfix='N'
							...
							If Empty(AllTrim(_lvtrc))
								ApMsgInfo("Transaction Code n„o digitado em nenhuma fase apontada para OS: "+ZZ4->ZZ4_OS+" e IMEI: "+ZZ4->ZZ4_IMEI+" . Favor digita-lo a seguir.","Transaction Code  n„o localizado!")
...
/*						ctransope := Posicione("ZZ1",1,xFilial("ZZ1") + LAB + LEFT(CODSE2,6) + LEFT(FAS2,2)+ SPACE(04),"ZZ1_ALTOPE")
						...
						If 	lUsrNext .And. ctransfix<> 'N' .And. cgarant='S'  .And. !Empty(AllTrim(ctransope)) .Or. ;
							...
							If Empty(AllTrim(cTransc))
								ApMsgInfo("Transaction Code n„o digitado em nehuma fase apontada para OS: "+ZZ4->ZZ4_OS+" e IMEI: "+ZZ4->ZZ4_IMEI+" . Favor digita-lo a seguir.","Transaction Code  n„o localizado!")
								Do While Empty(cTransc)
									OutInf(COPEBGH,CGARANT,@cSofIn,@csoftout,@cTransc,left(CODSETORI,6),_cfase1,cfastnfix,cfasouinf,cfasalltn,'3')
								ENDDO
							Endif
...
*/
				...
				If  ENCOS = "S"
					...
					If ctransfix='N' // Transaction NAO FIXO = MANUAL
...
//					ctransope := Posicione("ZZ1",1,xFilial("ZZ1") + LAB + LEFT(CODSE2,6) + LEFT(FAS2,2)+ SPACE(04),"ZZ1_ALTOPE")
				...
				if cinftrans == "S"
					...
					_cMesFabr   := u_TmpFabric(ZZ4->ZZ4_CARCAC, dtos(ZZ4->ZZ4_DOCDTE))
					_cOpeBGH    := iif(!empty(cTransOpe),cTransOpe,ZZ4->ZZ4_OPEBGH)
					_aTransCode := u_DefTrans(_cOpeBGH, ZZ4->ZZ4_GARANT, _cRecCli, ZZ4->ZZ4_CODPRO, _cMesFabr, _cSPC, cTransc, SWAP=="S", cRepair)
			...
			if _lContinua
				...
				_lobripart 	:= .F.  // obriga a cadastrar a partnumber quando no cadastro de fase estiver obrigatÛrio
				...
				If Posicione("ZZ1",1,xFilial("ZZ1") + LAB + IIf('/' $ ALLTRIM(CODSET),substr(ALLTRIM(CODSET),1,At('/',ALLTRIM(CODSET))-2),ALLTRIM(CODSET)) + _cfase1,"ZZ1_PARTNR") == "2"
					...
					_cGrava := .F.
					//_lobripart:=.T. Desabilitado, pois n„o h· necessidade de declarar novamente e estava causando problemas - Edson Rodrigues 29/03/10
					
					Do while  _lobripart  .And. len(_aRecnoSZ9) <= 0  // Incluso Edson Rodrigues - 19/07/09
						apMsgStop("De acordo com as regras È obrigatorio informar o partnumber para essa fase.","Por favor preencher")
						_lobripart :=.T.
						U_ADDPARTNO(1,_lADDPARTNO)
					Enddo
				ElseIf Posicione("ZZ1",1,xFilial("ZZ1") + LAB +  IIf('/' $ ALLTRIM(CODSET),substr(ALLTRIM(CODSET),1,At('/',ALLTRIM(CODSET))-2),ALLTRIM(CODSET)) + _cfase1,"ZZ1_PARTNR") == "1"
					If ApMsgYesNo("O Apontamento de Part. No para a Fase Atual È Opcional. Deseja Apontar um Part. No para este Item?")
						U_ADDPARTNO(1,_lADDPARTNO)
						_cGrava := .F.
					EndIf
				EndIf
				...
				If left(CODSET,6) == '000016' .And. left(FAS1,2) == '01'  .And. AllTrim(_cGarmcl) == 'S' .And. Left(_cMissue,6) $  _cIssue
					//	MsgAlert("Necess·rio Apontamento de PeÁas,Equipamento GARANTIA !!!","PE«AS - GARANTIA")
					If ApMsgYesNo("Necess·rio Apontamento de PeÁas,Equipamento GARANTIA. Equipamento ISSUE?","PE«AS - GARANTIA")
					...
					Else
						...
						If Empty(AllTrim(QRY2->PARTNR))
							...
							cMensagem += "OperaÁ„o : " + AllTrim(ZZ4->ZZ4_OPEBGH)+ _center
				...
				Else
					If Posicione("ZZ1",1,xFilial("ZZ1") + LAB +  IIf('/' $ ALLTRIM(CODSET),substr(ALLTRIM(CODSET),1,At('/',ALLTRIM(CODSET))-2),ALLTRIM(CODSET)) + _cfase1,"ZZ1_PECFAL") == "S"
						If ApMsgYesNo("Essa fase Indica que deve informar peÁa Faltante. Deseja Apontar a(s) PeÁa(s) Faltante(s) para este Item?")
							_lADDPECAF:=.T.
							U_ADDPECAF(1)
						EndIf
					EndIf
				...
				Do while  _lobrigpf .And. len(_aRecnoZZ7) <= 0  // // Incluso Edson Rodrigues - 19/07/09
					apMsgStop("De acordo com as regras È obrigatorio informar o partnumber faltante.","Por favor preencher")
					_lobrigpf :=.T.
					U_ADDPECAF(1)
				Enddo
...
/*					TICKET 4818 - M.MUNHOZ - 16/04/2012
					...
					If !Empty(AllTrim(ctransope))
						...
						Else
							MsgAlert("N„o Foi Possivel Alterar OperaÁıes Favor Entrar em Contato com Supervisor da Area")
						EndIf
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥GRAVA     ∫Autor  ≥Edson B. - ERP Plus ∫ Data ≥  15/05/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥Pergunta ao usu·rio se deseja gravar os apontamentos        ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
If _lREGACOLS
	...
	If ApmsgYesNo("Deseja gravar os apontamentos para futura confirmaÁ„o? Caso eles n„o sejam gravados neste momento, eles ser„o perdidos.","Grava apontamentos existentes?")
		U_STATUSOK(0)
	Else
		...
		For _nI := 1 To Len(_aRecnoZZ3)
			...
			//Retirado linhas de cÛdigos e incluso funcao Edson Rodrigues - 27/07/10
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥AXZZ3     ∫Autor  ≥Edson B. - ERP Plus ∫ Data ≥  12/05/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥                                                            ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
Private _cQtd		:= 0    //GetMv("MV_QTDETQM")  // Quantidade de Equipamentos para Impress„o Etiquetas Master // Retirado busca ao parametro - Edson Rodrigues 18/01/12
Private _cNumEtq
...
//Incluso condiÁ„o para voltar a apontar caso nao seja confirmado a mensagem abaixo - Edson Rodrigues - 01/10/10
For _nI := 1 To Len(_aRecnoZZ3)
							...
							If AB6->(dbSeek(xFilial("AB6") + left(ZZ3->ZZ3_NUMOS,6) )) .And. AB6->AB6_STATUS <> 'B' .And. ;
								...
								IF _nencerr == 1
									...
									IF empty(_cgarant) .and. _cvletcdu<>"S" .and. _cImpetqm="S" .and. _cvlgarm=="S"
										If ApMsgYesNo("Esse Aparelho n„o tem Garantia informada. Ele esta na GARANTIA ?","APARELHO GARANTIA SIM OU NAO ?")
											_cgarinf :="S"
										Else
											_cgarinf :="N"
										Endif
					...
					If !Empty(cArmPeca) .And. !Empty(cEndProd) .And. !Empty(cEndAudi) .And. !Empty(cArmScra) .And. !Empty(cEndScra)
						...
						If SZ9->(dbSeek(xFilial("SZ9") + ZZ3->ZZ3_IMEI + Left(ZZ3->ZZ3_NUMOS,6)))
							...
							While SZ9->(!Eof()) .And. xFilial("SZ9") == SZ9->Z9_FILIAL .And. Left(ZZ3->ZZ3_NUMOS,6) == AllTrim(SZ9->Z9_NUMOS) .And. ;
								...
								If lRet .And. !Empty(SZ9->Z9_PARTNR) .And. Empty(AllTrim(SZ9->Z9_NUMSEQ))
									
									aAdd(aDados,{ZZ4->ZZ4_OPEBGH, Left(SZ9->Z9_PARTNR,15), SZ9->Z9_SEQ, SZ9->Z9_NUMOS, SZ9->Z9_QTY, cArmPeca, cEndProd, cArmPeca, cEndAudi })
									
									/* Array para Transferencia de Armazem - EndereÁamento.
									Array aDados
									1-> OperaÁ„o,
									2-> ParNumber,
									3-> Num. Seq.,
...
IF _limpmas
	...
	IF _cvletcdu="S"  .and. !(lUsrNext .Or. lUsrAdmi)
		_cmsgetqm:= "Usu·rio NAO pertencente ao grupo Nextel ou Administradores. Sem autorizaÁao para encerrar erquipamentos com Impress„o da Etiqueta M·ster. Solicitar Permissao !"
	...
	Elseif !_lvalgar
		_cmsgetqm:= "Garantia :"+_cgarinval+" referente(s) a(s) OS(s) : "+_cOsgarInv+" s„o diferente(s) do primeiro num. serie apontado : "+_cnumser +" nesse encerramento. Delete a(s) Linha(s) do(s) mesmo(s e confirme o encerramento novmaente !"
		
		//Elseif (_cvletcdu="S" .or. _cImpetqm="S")   .And. _cimpmas=="S" .and.  ALLTRIM(CODSET) <> AllTrim(_csetmast)
		//	If ApmsgYesNo("Esse Apontamento se trata de um Encerramento para GeraÁ„o de Etiqueta Master ?")
		//		_cmsgetqm:= "Setor atual posicionado : "+left(CODSET,6)+"  n„o È permitido a impressao da etiqueta master. Setor(es) autorizado(s) :  "+AllTrim(_csetmast)+". Altere o Setor para fazer a Impress„o da Etiqueta Master !"
		//	Else
		//		_lImpetqm := .T.
		//	Endif
		...
		//	If ApmsgYesNo("Esse Apontamento se trata de um Encerramento para GeraÁ„o de Etiqueta Master ?")
		//		_cmsgetqm:= "Fase atual posicionada : "+left(CODSET,6)+"  n„o È permitido para impressao da etiqueta master. Fase(s) n„o autorizada(s0 :  "+AllTrim(_cfasemast)+". Altere o Setor para fazer a Impress„o da Etiqueta Master !"
		//	Else
		//		_lImpetqm := .T.
		//	Endif     
		
	Elseif !_lvalcli
		_cmsgetqm:= "Cliente(s) :"+_ccliinval+" referente(s) a(s) OS(s) : "+_cOscliInv+" s„o diferente(s) do primeiro num. serie apontado : "+_cnumser +" nesse encerramento. Delete a(s) Linha(s) do(s) mesmo(s e confirme o encerramento novmaente !"	
		
	Elseif !_lfasetm
		_cmsgetqm:= "A(s) OS(s) "+_cOssetfinv+" foi(ram) apontada(s) com os setor(es)/fase(s) : "+_cfasetinv+" de encerramento que n„o permite(m) a geraÁ„o de etiqueta master. Delete a(s) Linha(s) dessa(s) OS(s) e confirme o encerramento novmaente !"
		
	Elseif _cqetqfix="S" .and. len(_aEtiqMas) <> _cQtd
		_cmsgetqm:="Necess·rio total de " + strzero(_cQtd,3) + " equipamentos para finalizaÁ„o e Impress„o da Etiqueta M·ster. Existe(m) "+strzero(len(_aEtiqMas),3)+" Apontados !! . Verificar Apontamentos"
		
	Elseif  _cqetqfix="N" .and. len(_aEtiqMas) > _cQtd
		If ApmsgYesNo("A quantidade encerrada  : "+strzero(len(_aEtiqMas),3)+" para impress„o da etiqueta master È maior que a cadastrada para essa operaÁ„o : " +strzero(_cQtd,3) + ". Quer fechar com essa quantidade encerrada ?")
			_lImpetqm := .T.
		Else
			_cmsgetqm:= "quantidade encerrada : "+strzero(len(_aEtiqMas),3)+" È maior que a cadastrada para essa operaÁ„o : " +strzero(_cQtd,3) + ". Sem confirmaÁ„o do usu·rio !"
		Endif
...
If (_lencerr .or. _limpmas) .and. (_nencerr > 0 .or. len(_aEtiqMas) > 0 )
	IF _lImpetqm
		...
		IF  ApmsgYesNo("Ser· encerrado "+strzero(_nencerr,3)+" aparelho(s) e gerado 1 etiq. master com "+strzero(len(_aEtiqMas),3)+" itens. Deseja prosseguir com a confirmaÁ„o ? Caso n„o queira prosseguir, voce podera continuar apontando.","Re-Confirma gravacao de apontamentos existentes?")
...
For _nI := 1 To Len(_aRecnoZZ3)
	...
	If aCols[_nI,Len(_aCabec)+1] == .F. //Se Linha nao estiver deletada
		...
		// ainda existe no sistema ou se foi deletado por outro usu·rio // Edson Rodrigues - 27/07/10
		DBSELECTAREA("ZZ3")
		If (ZZ3->ZZ3_IMEI==aCols[_nI,_nPosIMEI] .And. LEFT(ZZ3->ZZ3_NUMOS,6)==LEFT(aCols[_nI, _nPosOS],6))
			...
			If ZZ4->(dbSeek(xFilial("ZZ4") + ZZ3->ZZ3_IMEI + left(ZZ3->ZZ3_NUMOS,6) ))
				...
				If ZZ3->ZZ3_ENCOS == "S" .And. _nStatus == 1 .And. ZZ3->ZZ3_STATUS == "1"
					...
					DBSELECTAREA("ZZ4")
					lvdaprod  :=U_VLDPROD(ZZ4->ZZ4_OPEBGH,ZZ3->ZZ3_LAB) //Valida operaÁıes para chamar a funÁ„o de inclus„o ou estorno de OP. Edson Rodrigues 05/05/10
					If lvdaprod
						dbselectarea("ZZJ")
						ZZJ->(dbsetOrder(1)) // ZZJ_FILIAL + ZZJ_OPEBGH+ ZZJ_LAB
						If ZZJ->(dbseek(xFilial("ZZJ")+ ZZ4->ZZ4_OPEBGH+ZZ3->ZZ3_LAB))
				...
				If _lContinua .And. ZZ4->(dbSeek(xFilial("ZZ4") + ZZ3->ZZ3_IMEI + left(ZZ3->ZZ3_NUMOS,6) )) .And. ;
					...
					If _lImpetqm
						...
						if _nPosetq > 0 .and. _aEtiqMas[_nPosetq,2] == ZZ4->ZZ4_IMEI
							...
							_lscreen  	:=.F.  // Forca Fechar a Tela e efetuar nova digitaÁ„o
							U_GRVLOGFA("002")   
						endif
					Endif
...
//******************************************************************************************************************************************************
				...
				Else
					// Incluso para voltar o status para zero quando houver falha na operaÁ„o SR - Edson Rodrigues 17/03/10
			...
			Else
				IF _lImpetqm
					...
					cTitemail:= " Nao Encerrado Etiqueta Master - IMEI e ou OS n„o encontrado no ZZ4 -  acolszz3 "+strzero(_nI,3)+". "
					cMensagem := "Equipamento Encerrado : "+DTOC(date())+" - "+time()+" hrs."+ _center
					...
					cMensagem += "Qde Encerrado apresentada ao usu·rio : "+STRZERO(_nencerr,3)+ _center
...
if len(_aImpEtiq) > 0 .and. ApMsgYesNo("Impressao de Etiqueta para equipamentos no encerramento, conforme parametrizado na fase. Confirma impress„o?","Impress„o de Etiquetas")
	U_EtqMass(_aImpEtiq)
endif
...
Elseif _lImpetqm .and. !_nqtdmas==len(_aEtiqMas)
	IF ApMsgYesNo("O Sistema encerrou : "+strzero(_nqtdmas,3)+" itens para etiqueta master : "+Transform(_cNumEtq, "@E 999999999999")+" ,enquanto o correto seria "+strzero(len(_aEtiqMas),3)+". Deseja prosseguir com a impress„o da etiqueta mesmo assim ?","Impress„o de Etiquetas")
		U_EtqGera1(_cNumEtq,'2',_cmodetq)
	Else
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ CALCSEQ  ∫Autor  ≥M.Munhoz - ERP Plus ∫ Data ≥  06/06/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Funcao para identificar a proxima sequencia a ser utilizada∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥AF190Vis  ∫Autor  ≥Marcos S. Lobo      ∫ Data ≥  13/11/03   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥VisualizaÁ„o da AmarraÁ„o Respons·veis x Bens (SND)         ∫±±
±±∫          ≥                                                            ∫±±
...
dbselectarea("ZZ4")
ZZ4->(dbSetOrder(1))  // ZZ4_FILIAL + ZZ4_IMEI + ZZ4_OS
//Modificado Paulo Francisco devido a apontamento de peÁas via coletores - 14/02/2012
/*dbselectarea("ZZ9")
SZ9->(dbSetOrder(1))  //Z9_FILIAL, Z9_NUMOS, Z9_CODTEC, Z9_SEQ, Z9_ITEM*/
dbselectarea("SZ9")
...
if ZZ3->ZZ3_ESTORN == "S"
	apMsgStop("Esta fase È um estorno e portanto n„o poder· ser estornada novamente. ","Fase n„o estornada")
	_lRet := .F.
endif

//Acrescentado Edson Rodrigues     22/02/10
if ZZ3->ZZ3_STATUS == "0"
	apMsgStop("Esta fase È tempor·ria e portanto n„o necessita de ser estornada. ","Fase n„o estornada")
	_lRet := .F.
endif
...
if _lRet .And. ZZ4->(dbSeek(xFilial("ZZ4") + ZZ3->ZZ3_IMEI + LEFT(ZZ3->ZZ3_NUMOS,6)))
	...
	if ZZ4->ZZ4_STATUS <> "4"  // Status 4 = em atendimento
		apMsgStop("Esta fase n„o poder· ser estornada porque o IMEI n„o est· em atendimento.","Fase n„o estornada")
		_lRet := .F.
	endif           
	
	if _lRet .And. ZZ4->ZZ4_ETQMAS <> 0 .AND. ZZ4->ZZ4_ETQMAS > 1  
	   	apMsgStop("Este aparelho n„o poder· ser estornado porque o IMEI est· vinculado h· uma etiqueta master : "+ TransForm(ZZ4->ZZ4_ETQMAS, "@E 999999999999") +" E necessario excluir toda Master. Contate seu Lider ou Supervisor.","Fase n„o estornada")
	   _lRet := .F.	  
	endif
endif
...
if _lRet .And. ZZ3->(dbSeek(xFilial("ZZ3") + _cIMEI + _cNumOS + _cSeq))
	...
	enddo
	if !_lRet
		apMsgStop("Esta fase n„o poder· ser estornada porque ela n„o È a ˙ltima fase. Dirija-se ‡ ˙ltima fase para efetuar o estorno.","Fase n„o estornada")
	endif
...
If SZ9->(dbSeek(xFilial("SZ9") + _cNumOS + _cSeq)) //Z9_FILIAL+Z9_NUMOS+Z9_SEQ+Z9_PARTNR
	...
	If !_lRet
		...
		apMsgStop("PeÁas Apontadas pelo Coletor Favor Remover as PeÁas.","Fase n„o estornada")
...
if _lRet .And. AxVisual(cAlias,nReg,nOpc) == 1
	...
	If !Empty(AllTrim(_ctransope))
		ZZ4->ZZ4_OPEBGH := ZZ4_OPEANT
		ZZ4->ZZ4_OPEANT := ""
		ZZ4->ZZ4_TRANSC := ""
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ FASMAX   ∫Autor  ≥ M.Munhoz - ERPPLUS ∫ Data ≥  05/11/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Funcao para verificar se a fase apontada possui grau maior ∫±±
±±∫          ≥ ou menor do que as fases anterioes                         ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥AXZZ3     ∫Autor  ≥Microsiga           ∫ Data ≥  09/26/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥                                                            ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥verfancf  ∫Autor  ≥Edson Rodrigues     ∫ Data ≥  24/05/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥Verifica se existe apontamentos da fase atual nao           ∫±±
±±∫          |nao confirmados por outros tecnicos                         ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥VerEncer  ∫Autor  ≥Edson Rodrigues     ∫ Data ≥  26/07/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥Ver se o ultimo apontamento esta encerrado e nao estornado  ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥Atransc   ∫Autor  ≥Paulo Francisco     ∫ Data ≥  17/02/11   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥Altera o Transaction conforme solicitacao Motorola          ∫±±
±±∫          |                                                            ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥VERFASTEC ∫Autor  ≥Microsiga           ∫ Data ≥  26/09/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Verifica se fase informada corresponde ao tecnico          ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥VERFASDEST∫Autor  ≥Microsiga           ∫ Data ≥  26/09/08   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Verifica se fase informada corresponde ao tecnico          ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥OutInf    ∫Autor  ≥ Edson Rodrigues    ∫ Data ≥  ??????     ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Tela para informar outras infromacoes das operacoes lab 2  ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥Outisix   ∫Autor  ≥ Edson Rodrigues    ∫ Data ≥  19/01/12   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Tela para informar outras infromacoes Sony brasil - SIX    ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥Vergaran  ∫Autor  ≥ Edson Rodrigues    ∫ Data ≥  20/05/2009 ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Calcula tempo de garantida do aparelho                     ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥Verdef    ∫Autor  ≥ Paulo Lopez        ∫ Data ≥  18/11/2010 ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Consulta Defeito Reclamado Cliente                         ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
cQry := "SELECT LEFT(SZA.ZA_DEFRECL, 5) +' / ' + ZZG.ZZG_DESCRI  AS DEFRECL" + ENTER
cQry += "FROM " + RetSqlName("SZA") + " SZA (nolock) " + ENTER
cQry += "LEFT JOIN " + RetSqlName("ZZG") + "  ZZG (nolock) " + ENTER
cQry += "ON (LEFT(SZA.ZA_DEFRECL, 5) = ZZG.ZZG_CODIGO AND SZA.D_E_L_E_T_ = ZZG.D_E_L_E_T_ ) " + ENTER
cQry += "WHERE SZA.D_E_L_E_T_ = ''  "+ ENTER
cQry += "AND ZZG.ZZG_LAB = '"+_clab+"' "+ ENTER
cQry += "AND SZA.ZA_NFISCAL = '"+_cnfenr+"' "+ ENTER
cQry += "AND SZA.ZA_NFISCAL = '"+_cnfeser+"' "+ ENTER
cQry += "AND SZA.ZA_CLIENTE = '"+_ccliente+"' "+ ENTER
cQry += "AND SZA.ZA_LOJA = '"+_cloja+"' "+ ENTER
cQry += "AND SZA.ZA_IMEI = '" +Left(IMEI,15) + "' "+ ENTER
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥GravDef   ∫Autor  ≥ Paulo Lopez        ∫ Data ≥  18/11/2010 ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Atualiza  Status do Defeito Reclamado na Tabela ZZM        ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
cQryExecUpZM += "AND ZZM_MSBLQL = '2' " + ENTER
cQryExecUpZM += "AND ZZM_IMEI = '"+_cImei+"' " + ENTER
...
cQryExecUpZA := "UPDATE " + RetSqlName("SZA") + ENTER
cQryExecUpZA += "SET ZA_CODRECL = ZZG.ZZG_RECCLI " + ENTER
cQryExecUpZA += "FROM " + RetSqlName("SZA") + " SZA (NOLOCK) " + ENTER
cQryExecUpZA += "INNER JOIN " + RetSQlName("ZZG") + " ZZG (NOLOCK) " + ENTER
cQryExecUpZA += "ON (SZA.ZA_DEFRECL = ZZG.ZZG_CODIGO AND SZA.D_E_L_E_T_ = ZZG.D_E_L_E_T_ AND ZZG.ZZG_LAB = '2' AND ZZG.ZZG_FILIAL = '') " + ENTER
cQryExecUpZA += "WHERE SZA.D_E_L_E_T_ = '' " + ENTER
cQryExecUpZA += "AND SZA.ZA_DEFRECL != '' " + ENTER
cQryExecUpZA += "AND ZZG.ZZG_RECCLI ! ='' " + ENTER
cQryExecUpZA += "AND SZA.ZA_IMEI = '"+_cImei+"' " + ENTER
...
If !DBSEEK(XFILIAL("SC2")+ALLTRIM(ZZ3->ZZ3_NUMOS))
	MsgAlert("AtenÁ„o, este apontamento esta sem amarraÁ„o com Ordem de ProduÁ„o, verifique!")
	return(.F.)
	
ElseIf DBSEEK(XFILIAL("SC2")+ALLTRIM(ZZ3->ZZ3_NUMOS)) .And. SC2->C2_QUJE = 0
	MsgAlert("Ordem de ProduÁ„o ja apontada, verifique com adm do sistema!")
	return(.F.)
EndIf
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥SRConsal  ∫Autor  ≥ Edson Rodrigues    ∫ Data ≥  10/03/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Processo Sony Refurbish - Consulta Saldo de Aparelhos e    ∫±±
±±∫          ≥ PeÁas                                                      ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
...
Else
	...
	//OpÁ„o para ver o saldo disponÌvel SB2 atravÈs de funÁ„o do sistema - Edson Rodrigues - 15/03/10
		...
		Else
			...
			If nSalb2  > 0 .And.  nSalbf > 0  .And. nSalbf >= _nZ9Qty
				...
				If !SD4->(DBSeek(xFilial('SD4')+left(_cnumos,6)+'01001  '+_cpeca+left(carmpeca,2)))
					// Desabilitado funÁ„o de inclus„o apontamento - Edson Rodrigues 20/03/10
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ ULTSAI   ∫Autor  ≥M.Munhoz - ERPPLUS  ∫ Data ≥  15/07/07   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Funcao para verificar data de ultima saida do IMEI para    ∫±±
±±∫          ≥ calcular BOUNCE.                                           ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
...
_cQry :="SELECT MAX(D2_EMISSAO) AS EMISSAO " 				+ ENTER
_cQry +="FROM " + RetSqlName("SD2") + " SD2 (nolock) " 		+ ENTER
_cQry +="WHERE "				 							+ ENTER
_cQry +="D2_FILIAL  = '" + xFilial("SD2") + "' AND "		+ ENTER
_cQry +="D2_NUMSERI = '" + _cSaiIMEI + "' AND "				+ ENTER
_cQry +="D2_EMISSAO < '" + _dEmisSai + "' AND "				+ ENTER
_cQry +="D_E_L_E_T_ = '' " 									+ ENTER
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ BLQIMEI  ∫ Autor ≥Paulo Francisco     ∫ Data ≥  14/07/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Descricao ≥ BLOQUEIO DOS EQUIPAMENTOS FORA DE GARANTIA                 ∫±±
±±∫          ≥                                                            ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Uso       ≥ GENERICO                                                   ∫±±
...
Local _cQry2
Local _cQryExec
Local cTitemail := "Equipamento Sem PeÁas"
...
_cQry :="SELECT TOP 1	ZZ4.ZZ4_CODCLI			CODCLI, 	" + ENTER
...
_cQry +="				ZZ4.ZZ4_OPEBGH 			OPEBGH,   	" + ENTER
_cQry +="				ZZ4.ZZ4_BOUNCE			BOUNCE,   	" + ENTER
_cQry +="				ZZ4.ZZ4_GARANT			GARANT,    	" + ENTER
_cQry +="				ZZ4.ZZ4_GARMCL			GARMCL,    	" + ENTER
_cQry +="				ZZ4.ZZ4_TRANSC			TRANSC,		" + ENTER
_cQry +="				ISNULL(SZA.ZA_GARNFC,'N') GARNFC,	" + ENTER
_cQry +="				ISNULL(SZA.ZA_GARNFT,'N') GARNFT,	" + ENTER
_cQry +="				ISNULL(SZA.ZA_SPC,'N')    GARSPC,	" + ENTER
_cQry +="				ZZ4.R_E_C_N_O_ ZZ4RECNO				" + ENTER
...
_cQry +="AND ZZ4.ZZ4_FILIAL = '" + xFilial("ZZ4") + "' " + ENTER
_cQry +="AND ZZ4.ZZ4_IMEI = '" +  IMEI + "' " + ENTER
_cQry +="ORDER BY ZZ4.R_E_C_N_O_ DESC " + ENTER
...
_csetmast	:= Posicione("ZZJ",1,xFilial("ZZJ")+AllTrim(QRY->OPEBGH),"ZZJ->ZZJ_SETMAS") // variavel que obtem setor de impressao de etiqueta Master BGH
...
// Confome Luiz Reis foi alterado a regra abaixo, onde a soluÁ„o nao È mais a R0035 e  sim R0034 e tambÈm nesse caso n„o tem mais necessidade da pergunta. Edson Rodrigeus - 22/03/12
/*
if alltrim(QRY->OPEBGH) == 'N04' .and. SWAP == 'S' .and. left(SOLUCAO,5) == 'R0034' .and. alltrim(QRY->TRANSC) <> "IFS" //.and. ;
    //apMsgYesNo('Esta transaÁ„o de Swap N04 refere-se a Fast Shop?','Fast Shop - Transaction Code')
	Begin Transaction
...
If Len(AllTrim(QRY->TRANSC)) > 0 .And. Len(AllTrim(_cOperalt))== 0 .And. Len(AllTrim(QRY->GARSPC))< 2 .And. LEFT(CODSE2,6) <> '000000' .And. LEFT(FAS2,2) <> '00'
	...
	Do Case
		...
		Case AllTrim(QRY->OPEBGH) == 'N01' .And. !(AllTrim(QRY->TRANSC) $ "IRR#IRF#IOW#IXT")
			...
			MsgAlert("Equipamento com Transaction Cod " + QRY->TRANSC + " Fora de Garantia, N„o Poder· Prosseguir !!!")
			_lRet := .F.
			
		Case AllTrim(QRY->OPEBGH) == 'N02' .And. !(AllTrim(QRY->TRANSC) $ "IR2#ITS#IOW#IXT")
			
			MsgAlert("Equipamento com Transaction Cod " + QRY->TRANSC + " , N„o Poder· Prosseguir !!!")
			_lRet := .F.
...
If _cOper == 'S' .And. !Empty(_nFase)
	If QRY->GARNFC == 'S' .Or. QRY->GARNFT == 'S'
		If QRY->GARANT == "N" .And. !(_nFase $ AllTrim(_cSfa))
			MsgAlert("Equipamento Fora de Garantia, N„o Poder· Prosseguir !!!")
			_lRet := .F.
		EndIf
	ElseIf QRY->GARNFC == 'N' .And. QRY->GARNFT == 'N' .And. Len(AllTrim(QRY->GARSPC))< 2 .And. !(_nFase $ AllTrim(_cSfa))
		MsgAlert("Favor Informar Nota Fiscal de Compra, N„o Poder· Prosseguir !!!")
		_lRet := .F.
	EndIf
EndIf
...
If !Empty(AllTrim(_cOpergar)).And. !(_nFase $ AllTrim(_cSfa))
	If AllTrim(QRY->GARANT) <> AllTrim(_cOpergar)
		MsgStop("Equipamento Fora de Garantia, N„o Poder· Prosseguir !!!")
		_lRet := .F.
	EndIf
EndIf
	...
	If Empty(AllTrim(_cOperalt))
		If !AllTrim(QRY->OPEBGH) $ AllTrim(_cOperfas)
			...
			If !Empty(AllTrim(_cVerFaseta))
				apMsgStop("O IMEI encontra-se na setor/fase: "+AllTrim(right(_cVerFaseta,6))+"/"+ AllTrim(left(_cVerFaseta,6))+" OperaÁ„o:" + AllTrim(QRY->OPEBGH) + " !","OperaÁ„o Divergente do Setor")
				_lRet := .F.
			Else
				MsgAlert("OperaÁ„o Divergente do Setor, N„o Poder· Prosseguir !!!")
				_lRet := .F.
			EndIf
		EndIf
	EndIf
...
If _lRet .And. _cvClimas='S' .and. !Empty(AllTrim(_cConfCli)) .And. AllTrim(_cConfCli) == 'S'
...
ElseIf left(CODSET,6) $ AllTrim(_csetmast) .And. Len(_aModBlq) > 0
	If _aModBlq[01,01] <> QRY->COD
		apMsgStop("Modelo Diferente dos Apontamentos em execuÁ„o","Divergencia Modelo")
		_lRet := .F.
	EndIf
EndIf                                                      
...
ElseIf _lRet .And. _cvgarmas='S' .and. !Empty(AllTrim(_cConfCli)) .And. AllTrim(_cConfCli) == 'S' .And. Len(_agarBlq) > 0
	If _agarBlq[01,01] <> QRY->GARANT
		apMsgStop("Garantia do Aparelho : "+QRY->GARANT+" , diferente dos Apontamentos em execuÁ„o","Divergencia Garantia")
		_lRet := .F.
	EndIf
Endif   
...
If QRY->OPEBGH == 'N04' .And. QRY->GARANT = 'S' .And. QRY->TRANSC $ 'IER' .And. Empty(AllTrim(QRY->GARSPC))
	...
	_cQryExec += "SET ZA_SPC = 'SPC0000515' " + ENTER
	_cQryExec += "WHERE ZA_CLIENTE = '" + QRY->CODCLI + "' " + ENTER
	_cQryExec += "AND ZA_LOJA = '" + QRY->LOJA + "' " + ENTER
	_cQryExec += "AND ZA_NFISCAL = '" + QRY->NFE + "' " + ENTER
	_cQryExec += "AND ZA_SERIE = '" + QRY->SERIE + "' " + ENTER
	_cQryExec += "AND ZA_IMEI = '" + QRY->IMEI + "' " + ENTER
...
_cQry1 :="SELECT ZL_TRANSAC TRANSC " + ENTER
_cQry1 +="FROM " + RetSqlName("SZL") + " ZL (nolock) " + ENTER
_cQry1 +="WHERE ZL.D_E_L_E_T_ = '' " + ENTER
_cQry1 +="AND ZL.ZL_CODPROB = '"+LEFT(DEFDET,5) +"' " + ENTER
_cQry1 +="AND ZL.ZL_CODIGO = '"+LEFT(SOLUCAO,5)+"' " + ENTER
...
If Len(AllTrim(LEFT(SOLUCAO,5)))>0
	...
	If Len(AllTrim(QRY->TRANSC))>0
		...
		If AllTrim(QRY->TRANSC) == "IER" .And. Substr(QRY1->TRANSC,1,1) <> "X"
			MsgAlert("Codigo de Defeito Constatado e SoluÁ„o inadequado, N„o Poder· Prosseguir !!!")
			_lRet := .F.
...
If _lSwap2 .And. lUsrNext .Or. _lSwap2 .And. lUsrAdmi
	...
	#IFDEF TOP
		...
		If !Empty(AllTrim((xVaTemp)->SEQ))
			...
			MsgAlert("Necessario Excluir Todas PeÁas Apontadas, N„o Poder· Prosseguir !!!")
			_lRet := .F.
...
If ENCOS == "S" .And. _lRet .And. lUsrNext .Or. ENCOS == "S" .And. _lRet .And. lUsrAdmi
	...
	If Empty(AllTrim(CODANA)) .Or. !("C" $ CODANA)
		...
		MsgAlert("Necessario Apontar Codigo Analista Classificando CÈlula, N„o Poder· Prosseguir !!!")
		_lRet := .F.
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ EXCLAPON ∫Autor  ≥Edson Rodrigues     ∫ Data ≥  27/07/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Funcao para excluir registro de apontamento do ZZ3 quando  ∫±±
±±∫          ≥ nao atender condicoes para Inclus„o ou  alteracao e quando ∫±±
±±∫          ≥ o usuario resolver cancelar a inclusao dos apontamentos    ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
If !ZZ3->ZZ3_STATUS='1'
	If  ZZ3->ZZ3_IMEI==aCols[_nI,_nPosIMEI] .And. LEFT(ZZ3->ZZ3_NUMOS,6)==LEFT(aCols[_nI,_nPosOS],6) //Acrescentado para verificar se o acols esta posicionado certo no recno // Edson Rodrigues - 11/03/10
		...
		//-----|| EXCLUI Empenhos ou Apontamento da OP - Processo Refurbish  - mesmo que a mesma pode est· encerrada sem apontamento de peÁas
		Dbselectarea("ZZ4")
		DBSETORDER(1)
		If DBSEEK(XFILIAL("ZZ4")+ZZ3->ZZ3_IMEI+LEFT(ZZ3->ZZ3_NUMOS,6))
			lvdaprod  :=U_VLDDREQ(ZZ4->ZZ4_OPEBGH,ZZ3->ZZ3_LAB) //Valida operaÁıes para chamar a funÁ„o de inclus„o ou estorno de OP. Edson Rodrigues 05/05/10
			...
			Else
				...
				For _nH := 1 To Len(_aRegSZ9)
					...
					//-----|| Colocada minha funÁ„o antes da chamada da funÁ„o do Eduardo mais abaixo, pois a a dele sÛ funcionar· se a OP estiver em aberto.
					If lvdaprod
						_lencrrado:=IIf(ZZ3->ZZ3_ENCOS=='S' .And. ZZ3->ZZ3_STATUS=='1' ,.T.,.F.)
					...
					If !Empty(SZ9->Z9_NUMSEQ)
						...
						lvdadreq  :=U_VLDDREQ(cOpe,cLab) //Valida operaÁıes para chamar a funÁ„o de inserÁ„o/alteraÁ„o de Mov. Interno. Edson Rodrigues 24/03/10
						...
						If lFazReq .And. lvdadreq
							...
							Else
								MsgAlert("N„o foi encontrado a sequencia de movimentaÁ„o para a peÁa/OP : "+ALLTRIM(SZ9->Z9_PARTNR)+"/"+LEFT(SZ9->Z9_NUMOS,6)+"01001 "+" no armazÈm : "+ZZJ->ZZJ_ALMEP+" . Verifique ou entre contado com o Administrador do Sistema ! ")
							EndIf
						EndIf
					EndIf
	...
	EndIf
Else
	apMsgStop("O IMEI/OS : "+ALLTRIM(ZZ3->ZZ3_IMEI)+"/"+ALLTRIM(ZZ3->ZZ3_NUMOS)+"  n„o foi apagado, pois esta com status j· confirmados. ","Use a rotina de estorno para cancelar esse IMEI")
EndIf
return()
/*
‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ EXCLAPO2 ∫Autor  ≥Edson Rodrigues     ∫ Data ≥  29/07/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Funcao para excluir registro de apontamento do ZZ3 quando  ∫±±
±±∫          ≥ usuario desejar cancelar apontamentos j· inclusos ou fazer ∫±±
±±∫          | estorno de atendimentos.                                   ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
	...
	While SZ9->(!eof()) .And. SZ9->Z9_FILIAL == xFilial("SZ9") .And. ;
		...
		If !Empty(SZ9->Z9_NUMSEQ)
			...
			If lFazReq .And. lvdadreq
				dbselectarea("SD3")
				DBSETORDER(4)
				//If DBSEEK(XFILIAL("SD3")+ALLTRIM(SZ9->Z9_NUMSEQ)) //Alterarado a busca para encontrar o registro correto nos caso onde j· houve estorno. Edson Rodrigues 30/03/10
				If DBSEEK(XFILIAL("SD3")+ALLTRIM(SZ9->Z9_NUMSEQ)+'E0'+SZ9->Z9_PARTNR)
					// Desabilitado  o seek abaixo, pois j· faz as validaÁıes acima no retorno da vari·vel lvdadreq - Edson Rodrigues - 24/03/10
					//dbselectarea("ZZJ")
					//dbsetorder(1)
					//DBSEEK(XFILIAL("ZZJ")+cOPE+cLab)
					//If   !Empty(ZZJ->ZZJ_CODSF5) .And. !Empty(ZZJ->ZZJ_ALMEP) // Incluso Edson Rodrigues - 20/03/10 - Para entrar na funÁ„o somente quando estiver preenchido o armazÈm de processo e CÛdigo de MovimentaÁ„o Interna no cadastro de OperaÁıes
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ APONPECA ∫Autor  ≥Edson Rodrigues     ∫ Data ≥  27/07/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Funcao generica para fazer validacao e apontamento da OP de∫±±
±±∫          ≥ pecas quando no encerramento do atendimento da  OS         ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
If LEN(_aRecnoZZ3[_ni,2]) > 0
	...
	For _nH := 1 To Len(_aRegSZ9)
		...
		// Alterado o If para contemplar a novo mÈtodo de baixar as peÁas sem fazer empenho - Edson - 25/03/10
		If !Empty(SZ9->Z9_PARTNR) .And.  SZ9->Z9_USED="0" .And. SZ9->Z9_STATUS<>"0"  .And. !Empty(SZ9->Z9_NUMSEQ)
			...
			//Verifica saldo disponÌvel
			//Desabilitado funÁ„o Consulta de Saldo das PeÁas  - Edson Rodrigues 20/03/10
		...
		If _lempenh .And. _lContinua //.And.  len(_aEmpenh) > 0
			lInclui:=.T.
			// Desabilitado funÁ„o de Inclus„o de apontamento - Edson Rodrigues 20/03/10
			//NMODULO:=04
			//CMODULO:="EST"
	...
	If _lempenh
		...
		EndIf
	Else
		If _lnotprnz9 // Faz o apontamento, mesmo que n„o haja partnumber, ou seja faz apontamento sÛ do aparelho a reformar
			_aAponOP   := {}
			SB1->(DBSeek(xFilial('SB1')+_cnewpro))
			If !SB2->(DBSeek(xFilial('SB2')+_cnewpro+left(carmproc,2)))
				U_saldoini(_cnewpro,left(carmproc,2))
				...
				If len(_aEmptrue) > 0
					For  x:=1 to len(_aEmptrue)
						...
						If SD4->(DBSeek(xFilial('SD4')+_aEmptrue[x,3]+_aEmptrue[x,1]+_aEmptrue[x,2]))
							lInclui:=.F.
							_lgeraemp:=.T.
							// Desabilitado funÁ„o de exclus„o de apontamento - Edson Rodrigues 20/03/10
							//U_SRAdEmp(_aEmptrue[x,1],_aEmptrue[x,2],_aEmptrue[x,3],_aEmptrue[x,5],_aEmptrue[x,6],_aEmptrue[x,7],_aEmptrue[x,8],@_aEmpenh,@lInclui,@_lempenh,@_lgeraemp)
							NMODULO:=28
							CMODULO:="TEC"
						EndIf
		...
		Else
			...
			_laponta:=.F.
			// apMsgStop("Processo Refurbish Sony - Houve Falha no empenho das peÁas da OP : "+AllTrim(LEFT(ZZ4->ZZ4_OS,6))+ " Favor empenhar a(s) peca(s) nao apontada(s). Duvidas Contate o administrador do sistema. Falha no apontamento.")
			_lContinua:=.F.
		EndIf
	EndIf
Else
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ CONSGA09 ∫ Autor ≥Paulo Lopez         ∫ Data ≥  29/12/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Descricao ≥ATUALIZA CAMPOS CONFORME PARAMETROS DETERMINADOS            ∫±±
±±∫          ≥SPC0000433 - PERIODO DE 15 A 20 MESES                       ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Uso       ≥ GENERICO                                                   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫                     A L T E R A C O E S                               ∫±±
...
If Alltrim(QRY1->GARANT) == 'N' .And. AllTrim(QRY1->COD) $ _cSpr .And. Transform (QRY1->MES_GARA, "@E 99") $ _cPsq .And. AllTrim(QRY1->GARACARC) <= _cSpx .And.  IIF(_lspc433,AllTrim(QRY1->PFOUND) $ _cSpf, Iif (!Empty(QRY3->RECCLI), AllTrim(QRY3->RECCLI) <> 'C0022', .F.))
	...
	Else
		...
		if _lspc433
			cQryExec += " SET ZA_SPC = 'SPC0000433', ZA_EXECAO = 'S', ZA_NOMUSER = '" + AllTrim(cUserName) + "-" + DtoC(dDataBase) + "-" + Time() + "' " + ENTER "
		Else
			cQryExec += " SET ZA_EXECAO = 'S', ZA_NOMUSER = '" + AllTrim(cUserName) + "-" + DtoC(dDataBase) + "-" + Time() + "' " + ENTER
		Endif
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ PROREPA  ∫ Autor ≥Paulo Lopez         ∫ Data ≥  18/02/11   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Descricao ≥ATUALIZA CAMPOS DEFEITO INFORMADO PELO CLIENTE              ∫±±
±±∫          ≥                                                            ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Uso       ≥ GENERICO                                                   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
...
cQryExec	+= "WHERE Z3.D_E_L_E_T_ = '' " + ENTER
...
cQryExec	+= "AND Z3.ZZ3_STATUS = '1' " + ENTER
...
cQryExec1	+= "WHERE Z3.D_E_L_E_T_ = '' " + ENTER
...
cQryExec1	+= "AND Z3.ZZ3_STATUS = '1' " + ENTER
...
Else
	...
	_cQryExec	+= "WHERE Z3.D_E_L_E_T_ = '' " + ENTER
	...
	_cQryExec	+= "AND Z3.ZZ3_STATUS = '1' " + ENTER
	...
	_cQryExec1	+= "WHERE Z3.D_E_L_E_T_ = '' " + ENTER
	...
	_cQryExec1	+= "AND Z3.ZZ3_STATUS = '1' " + ENTER
...
If !Empty(AllTrim(cproblem)) .And. !Empty(AllTrim(creparo))
	...
	_cQryReapir := " UPDATE  " + RetSqlName("ZZ4") + ENTER
	_cQryReapir += " SET ZZ4_PROBLE = '" + AllTRim(cproblem) + "', ZZ4_REPAIR = '" + AllTrim(creparo)+ "' " + ENTER
	_cQryReapir += " WHERE D_E_L_E_T_ = '' " +  ENTER
	_cQryReapir += " AND ZZ4_IMEI = '" + cimei + "' " + ENTER
	_cQryReapir += " AND ZZ4_OS  = '" + Left(cos,6) + "' " + ENTER
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥NumEtq    ∫ Autor ≥Paulo Lopez         ∫ Data ≥  11/08/11   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Descricao ≥Consulta Numero Etiqueta Master                             ∫±±
±±∫          ≥                                                            ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Uso       ≥ GENERICO                                                   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥CONSGA    ∫ Autor ≥Paulo Lopez         ∫ Data ≥  13/10/10   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ TMPFABRIC∫Autor  ≥ M.Munhoz           ∫ Data ≥  26/04/12   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Funcao para calculo do Tempo de Fabricacao                 ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ DEFTRANS ∫Autor  ≥ M.Munhoz           ∫ Data ≥  26/04/12   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Funcao exclusiva para definir o Transaction e a Garantia   ∫±±
±±∫          ≥ MCLAIM.                                                    ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
...
user function DefTrans(_cOpeBGH, _cGarant, _cRecCli, _cCodPro, _cMesFabr, _cSPC, _cZZ3Trans, _lSwap, _cSolucao)
...
if ZZJ->(dbSeek(xFilial("ZZJ") + _cOpeBGH + "2")) .and. ZZJ->ZZJ_INFTCM == "S"
	...
	elseif ZZJ->ZZJ_TRAFIX == "N"
		...
		if ZZJ->ZZJ_OPERA == "N02" 
			if _cZZ3Trans == "IOW" .and. !empty(_cSPC)
				_cTrans := "ITS"
			endif
		// Excecoes para a operacao N04 - Nextel Varejo Lojas DOA
		elseif ZZJ->ZZJ_OPERA == "N04" 
			if _cZZ3Trans <> "IOW" .and. _cFasOrc $ _cOrcMCL // Fases de Orcamento
				_cTrans := "IOW"
	...
	elseif ZZJ->ZZJ_TRAFIX == "C"
		...
		elseif _cGarant == "S" .and. (empty(_cRecCli) .or. _cRecCli == "C0022") .and. _cOpeBGH $ "N01/N10/N11"
			_cTrans := "IRF"
		elseif _cGarant == "N" .and. _cCodPro $ _cSPC433 .and. _cMesFabr $ _cPerSPC3 .and. !empty(_cRecCli) .and. _cRecCli <> "C0022"
			_cTrans := "IXT"
