//
//QUERY PARA PRODUTOS DE NFS DE ENTRADA E SAIDA
//
SELECT B1_COD,B1_DESC,B1_CRICMS,D1_TES TES,F4_CF,F4_TEXTO  
FROM SD1130 SD1, SF1130 SF1, SF4130 SF4, SB1130 SB1       
WHERE SD1.D1_FILIAL = '01' AND 
SD1.D1_DTDIGIT >= '20140101' AND 
...
SB1.D_E_L_E_T_ <> '*' 
GROUP BY B1_COD,B1_DESC,B1_CRICMS,D1_TES,F4_CF,F4_TEXTO 
UNION ALL
SELECT B1_COD,B1_DESC,B1_CRICMS,D2_TES TES,F4_CF,F4_TEXTO 
FROM SD2130 SD2, SF4130 SF4, SB1130 SB1 
WHERE SD2.D2_FILIAL = '01' AND 	  
SD2.D2_EMISSAO >= '20140101' AND 
