...
If TSCONF->(Eof())
    ...
    //Conforme GLPI 18 764 - inclusใo de EOL nas conferencias
    If(lEOL)
...
TRCell():New(oSection1,"BGH_IMEI","TRB","IMEI","@!",20)
...
PutSx1(cPerg, '04', 'EOL         ?','' ,'' , 'mv_ch4', 'N', 01, 0,01 ,'C', '',   '' , '', '', 'mv_par04',"Sim","","","","Nao","","",)
Return
