...
±±ºPrograma  ³valvisger ºAutor  ³Edson Rodrigues     º Data ³  08/02/11   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     |Valida digitacao do campo Entidade gerencial quando a visao º±±
±±º          |Gerencial for o codigo 200                                  º±±
...
Elseif _codvis='200' .and. (altera .or. inclui)  .and.  readvar() == "M->CTS_DESCCG" .and. _codcls=='2'
    ...
    IF nDivi==0 
      msgstop("Obrigatorio digitar a entidade valida, com uma barra '/' separando a Conta do C.Custo. Objetivo: formar um código de entidade válido (Conta + C.Custo - BGH-AR) para a Visao 200.","Entidade sem barra ' / '","STOP") 
