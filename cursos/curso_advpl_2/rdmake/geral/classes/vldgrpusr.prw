...
Method New(cGrupo, cUser, lMsg) Class VldGrpUsr
	...
	::aGrupos 	:= aClone(UsrRetGRP(CUSERNAME, __CUSERID)) &&Retorna um array contendo os códigos dos grupos em que o usuário pertence..
...
Method VldAcessUsr() Class VldGrpUsr
	...
	If !::lUsrAut
		cMsg := "USUARIO NÃO AUTORIZADO!"+CRLF 
	 	cMsg += "Entre em contato com o seu superior para analise e posteriormente solicitar liberação ao TI. "
