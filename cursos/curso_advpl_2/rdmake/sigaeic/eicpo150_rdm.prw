...
// Para imprimir um BitMap
oSend(oPrn, "SayBitmap", Linha, 100, "lgrl02.BMP" , 400, 200 )  
...
oSend( oPrn, "Say",  Linha,/*1250*/1450, AllTrim(SA2->A2_NREDUZ) + Space(2) + IF(EICLOJA(), LITERAL_STORE /*"Loja:"*/ + Alltrim(SA2->A2_LOJA),"") ,aFontes:TIMES_NEW_ROMAN_08_NEGRITO,,,,1 ) //FDR - 06/01/12
