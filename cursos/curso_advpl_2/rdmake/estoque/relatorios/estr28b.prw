...
ฑฑบPrograma  ณESTR28B   บAutor  ณMarcos Zanetti GZ   บ Data ณ  21/12/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Checagem de fechamento de estoque por lote                 บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
user function ESTR28B(_dDtIni, _dDtFim, _cFilial, _nDestino)
...
private cDesc3       := "Checagem de Fechamento - por Lote "
Private lAbortPrint	 := .F.
Private limite       := 220
Private tamanho      := "G"
Private nomeprog     := "ESTR28B"
Private wnrel      	 := "ESTR28B"
Private nTipo        := 18
Private aReturn      := { "Zebrado", 1, "Administracao", 2, 2, 1, "", 1}
Private nLastKey     := 0
Private cPerg      	 := "ESTR18"
private titulo       := "Checagem de Fechamento - por Lote"
private _nLin        := 80
...
//private _cArq		 := "ESTR28B.XLS"                      
private _cArq		 := "ESTR28B.CSV"                      
...
Private _cQuebra	:= 	"" 	// Expressao de condicao de quebra - Carregada em ESTR28BORD()
Private _cQueryOrd 	:= 	"" 	// Ordenacao da Query - Carregada em ESTR28BORD()
...
_nQuebras := ESTR28BORD() // Chama funcao responsavel pela carga do array de ordens

Cabec1 := space(_nDesloc)+Cabec1
Cabec2 := space(_nDesloc)+Cabec2
//memowrite("\LOGRDM\"+ALLTRIM(PROCNAME())+".LOG",Dtoc(date()) + " - " + time() + " - " +cUsername)

MsAguarde({||ESTR28BSQL(_dDtIni, _dDtFim, _cFilial, _nDestino)},"Aguarde","Selecionando Dados",.F.)
...
if _nRegQry > 0
	if _nDestino == 1 // Nao gera arquivo Excel
		RptStatus({|| ESTR28BIMP(_dDtIni, _dDtFim) },Titulo)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuno    ณESTR28BSQLบ Autor ณ Marcos Zanetti GZ  บ Data ณ  22/06/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
Static Function ESTR28BSQL(_dDtIni, _dDtFim, _cFilial, _nDestino)
local _cQuery	:= ""

_cQuery += CR + " SELECT "
_cQuery += CR + " SBJ.BJ_FILIAL FILIAL, SBJ.BJ_COD PRODUTO, SB1.B1_DESC DESCPRO, SBJ.BJ_LOTECTL LOTE, SBJ.BJ_NUMLOTE SUBLOTE, SBJ.BJ_LOCAL ALMOX, "
_cQuery += CR + " Q1.QUANT QTD_MOV, SBJ.BJ_QINI QTD_FECH, Q1.QUANT-SBJ.BJ_QINI QTD_DIF"

_cQuery += CR + " FROM " + RetSQLName("SB1")+ " SB1 (nolock) , " + RetSQLName("SBJ")+ " SBJ (nolock) , "

_cQuery += CR + " (SELECT PRODUTO, LOTE, SUBLOTE, ALMOX, SUM(QUANT) QUANT FROM "
_cQuery += CR + " ("
...
_cQuery += CR + " AND SD5.D5_DATA <= '" + dtos(_dDtFim) + "'"
_cQuery += CR + " AND SD5.D5_DATA >  '" + dtos(_dDtIni) + "'"
...
_cQuery += CR + " AND BJ_DATA = '" + dtos(_dDtIni) + "'"
_cQuery += CR + " AND BJ_FILIAL = '" + _cFilial + "'"

_cQuery += CR + " ) T"
_cQuery += CR + " GROUP BY PRODUTO, LOTE, SUBLOTE, ALMOX"

_cQuery += CR + " ) Q1"

_cQuery += CR + " WHERE SB1.D_E_L_E_T_ = ' ' AND SBJ.D_E_L_E_T_ = ' ' "
_cQuery += CR + " AND SBJ.BJ_DATA    = '" + dtos(_dDtFim) + "'"
_cQuery += CR + " AND SBJ.BJ_COD     = Q1.PRODUTO"
_cQuery += CR + " AND SBJ.BJ_COD     = SB1.B1_COD"
_cQuery += CR + " AND SBJ.BJ_LOTECTL = Q1.LOTE"
_cQuery += CR + " AND SBJ.BJ_NUMLOTE = Q1.SUBLOTE"
_cQuery += CR + " AND SBJ.BJ_LOCAL   = Q1.ALMOX"
_cQuery += CR + " AND SBJ.BJ_FILIAL  = '" + _cFilial + "'"
_cQuery += CR + " AND ROUND(SBJ.BJ_QINI-Q1.QUANT,2)<>0"
_cQuery += CR + " AND '" + dtos(_dDtFim) + "' > '" + dtos(_dDtIni) + "'"

_cQueryOrd	:= " ORDER BY " + _cQueryOrd

//memowrite("ESTR28B.SQL",_cQuery + CR + _cQueryOrd)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuno    ณESTR28BIMPบ Autor ณ Marcos Zanetti GZ  บ Data ณ  22/06/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
Static Function ESTR28BIMP(_dDtIni, _dDtFim)
local _aTexto
local _nContaFor
Local _cQuebSoma 	:= ""
Local _cQuebTit 	:= ""
...
While QUERY->(!eof())
	...
	ESTR28BQUEB() // Funcao responsavel pelas quebras
...
ฑฑบFuno    ณESTR28BQUEBบ Autor ณ Marcos Zanetti GZ  บ Data ณ  22/06/04  บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuno    ณESTR28BORDบ Autor ณ Marcos Zanetti GZ  บ Data ณ  22/06/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
if _nOrdem == 1
	...
	"QUERY->FILIAL",;
	"ALMOX, PRODUTO, LOTE, SUBLOTE",.F.})
	_nDesloc := len(_aQuebras)*_nTamDesloc
	
	Cabec1 := 	"_________________________________PRODUTO___________________________________         ______________________ QUANTIDADE ______________________"
	Cabec2 := 	"CำDIGO            DESCRIวรO                            LOTE        SUBLOTE   ALM           MOVIMENTO          FECHAMENTO           DIFERENวA"
	
	aadd(_aCampos , {"QUERY->PRODUTO"	, "", 000, .F. })
	aadd(_aCampos , {"QUERY->DESCPRO"	, "", 018, .F. })
	aadd(_aCampos , {"QUERY->LOTE"		, "", 055, .F. })
	aadd(_aCampos , {"QUERY->SUBLOTE"	, "", 067, .F. })
	aadd(_aCampos , {"QUERY->ALMOX"		, "", 077, .F. })
	
	aadd(_aCampos , {"QUERY->QTD_MOV"	, PesqPict("SB9","B9_QINI")		, 085, .T. })
	aadd(_aCampos , {"QUERY->QTD_FECH"	, PesqPict("SB9","B9_QINI")		, 105, .T. })
	aadd(_aCampos , {"QUERY->QTD_DIF"	, PesqPict("SB9","B9_QINI")		, 125, .T. })
