...
while SC7->(!eof()) .and. SC7->C7_FILIAL == _cFilSC7
	...
	_dDtEnt := Iif( SC7->C7_DATPRF < _dDtRef, _dDtRef, DataValida(SC7->C7_DATPRF))
	
	_nValPC := (1+SE4->E4_ACRSFIN/100) * ((SC7->C7_QUANT-SC7->C7_QUJE)/SC7->C7_QUANT) * (SC7->C7_TOTAL - SC7->C7_VLDESC)
