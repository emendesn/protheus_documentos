...
±±ºPrograma  ³LP670CR   ºAutor  ³ Edson Rodrigues    º Data ³17/12/2009   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Programa para retorno da conta a credito para todas as se-  º±±
±±º          ³quencias do lancamento padronizado 670 - Transferências /  -º±±
±±º          ³Transferências Mod 2 - Saída de saldo em estoque (requisição)±±º 
±±º          - movimento origem.                                         -º±±
±±º                                                                      -º±±
