...
Local cChaveD1		:= ""
Local aMensAux		:= {}
Local cVoperDoc	:= ""   // Variavel para informar o valor total da Operação do doc Original conforme chamado TIGZGX
...
If !Empty(aNota)
	cString := ""
	cString += NfeIde(@cNFe,aNota,cNatOper,aDupl,aNfVinc,cVerAmb,aNfVincRur,aRefECF,cIndPres,aDest,aProd,aExp,cVoperDoc)
	...
	cString += NfeInfAd(cMensCli,cMensFis,aPedido,aExp,cAnfavea,aMotivoCont,aNota,aNfVinc,aProd,aDI,aNfVincRur,aRetido,cNfRefcup,cSerRefcupc,cTipo,nIPIConsig,nSTConsig,lBrinde,cVerAmb,cVoperDoc)
	cString += "</infNFe>"
EndIf
Return({cNfe,EncodeUTF8(cString),cNotaOri,cSerieOri})

Static Function NfeIde(cChave,aNota,cNatOper,aDupl,aNfVinc,cVerAmb,aNfVincRur,aRefECF,cIndPres,aDest,aProd,aExp,cVoperDoc)
...
Else                                       
//	cString += '<vUnCom>'+ConvType(aProd[16],21,4)+'</vUnCom>'	Original com 4 casa deciamis. Alterado para regra BGH com 8 decimais.
	cString += '<vUnCom>'+ConvType(aProd[16],21,8)+'</vUnCom>'	
Endif
...
Else
//	cString += '<vUnTrib>'+ConvType(aProd[10]/aProd[12],21,4)+'</vUnTrib>'	Original com 4 casa deciamis. Alterado para regra BGH com 8 decimais.
	cString += '<vUnTrib>'+ConvType(aProd[10]/aProd[12],21,8)+'</vUnTrib>'	
Endif
...
Static Function NfeInfAd(cMsgCli,cMsgFis,aPedido,aExp,cAnfavea,aMotivoCont,aNfSa,aNfVinc,aProd,aDI,aNfVincRur,aRet,cNfRefcup,cSerRefcup,cTipo,nIPIConsig,nSTConsig,lBrinde,cVerAmb,cVoperDoc)
